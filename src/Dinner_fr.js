...
const Dinner_fr = () => {
    ...
    <div className="alllunch">
      <Sidebar/>
        ...
        <p1><BackButton/></p1>
    <div className="lunch">
    <h2>{locale.dinner_recipes}</h2>
        <ul>
        {data.sort(sortMethods[sortState].method).filter((recipe) => {if(recipe.meal=="Dinner"){return recipe}}).map((recipe) => (
