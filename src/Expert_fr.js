...
const Expert_fr = () => {
    ...
    <div className="alllunch">
      <Sidebar/>
        ...
        <p1><BackButton/></p1>
    <div className="lunch">
    <h2>{locale.expert_recipes}</h2>
        <ul>
        {data.sort(sortMethods[sortState].method).filter((recipe) => {if(recipe.experience==locale.expert){return recipe}}).map((recipe) => (
