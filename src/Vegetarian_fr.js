...
const Vegetarian_fr = () => {
    ...
    <div className="alllunch">
      <Sidebar/>
        ...
        <p1><BackButton/></p1>
    <div className="lunch">
    <h2>{locale.vegetarian_recipes}</h2>
        <ul>
        {data.sort(sortMethods[sortState].method).filter((recipe) => {if(recipe.vegetarian==locale.vegetarian){return recipe}}).map((recipe) => (
