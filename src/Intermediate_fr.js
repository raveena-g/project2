...
const Intermediate_fr = () => {
    ...
    <div className="alllunch">
      <Sidebar/>
        ...
        <p1><BackButton/></p1>
    <div className="lunch">
    <h2>{locale.intermediate_recipes}</h2>
        <ul>
        {data.sort(sortMethods[sortState].method).filter((recipe) => {if(recipe.experience==locale.intermediate){return recipe}}).map((recipe) => (
...
export default Intermediate_fr;